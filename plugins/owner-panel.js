...
> Perintah : ${usedPrefix + command} nomer/tag`);
            ...
            let f = await fetch(domain + "/api/application/users", {
                ...
                "body": JSON.stringify({
                    "email": 'admin' + profil.toString() + '@yudahost.xyz',
                    "username": 'yudahost' + profil.toString(),
                    "first_name": 'yudahost' + profil.toString(),
                    "last_name": "yudaHost Offc",
                    "language": "en",
                    "password": 'yudahost' + password.toString()
                })
            })
...
✅Toko : yudaHost Store`,})
        ...
        case 'listusr': {
            ...
            await conn.sendMessage(m.chat, {
                text: "Berikut list user *yudaHOST PANEL*",
...
⛔EXPIRED : 1 Bulan`)
        ...
        case 'listsrv': {
            ...
            await conn.sendMessage(m.chat, {
                text: "Berikut list server *yudaHOST PANEL*",
                footer: `Page: ${res.meta.pagination.current_page}/${res.meta.pagination.total_pages}`,
                title: "*yudaHOST PANEL*",
